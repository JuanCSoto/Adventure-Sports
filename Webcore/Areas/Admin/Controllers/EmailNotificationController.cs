// <copyright file="EmailNotificationController.cs" company="Dasigno">
...
namespace Webcore.Areas.Admin.Controllers
{
    ...
    /// <summary>
    /// Controller for EmailNotification module
    /// </summary>
    [ModulAuthorize]
    public class EmailNotificationController : AdminController
    {
        /// <summary>
        /// gets the home of EmailNotification module
        /// </summary>
        ...
        public ActionResult Index(int mod, int? sectionId)
        {
            ...
            return this.View(new EmailNotificationTemplateModel()
            {
        ...
        /// <summary>
        /// inserts or updates a item EmailNotification
        /// </summary>
