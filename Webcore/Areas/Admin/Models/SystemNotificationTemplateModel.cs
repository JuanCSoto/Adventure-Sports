// <copyright file="SystemNotificationTemplateModel.cs" company="Dasigno">
...
namespace Webcore.Areas.Admin.Models
{
    ...
    /// </summary>
    public class SystemNotificationTemplateModel : IAdmin, IContent
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemNotificationTemplateModel"/> class
        /// </summary>
        public SystemNotificationTemplateModel()
        {
        }
        ...
        /// </summary>
        public SystemNotificationTemplate SystemNotificationTemplate { get; set; }
