// <copyright file="EmailNotificationTemplateModel.cs" company="Dasigno">
...
namespace Webcore.Areas.Admin.Models
{
    ...
    /// </summary>
    public class EmailNotificationTemplateModel : IAdmin, IContent
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailNotificationTemplateModel"/> class
        /// </summary>
        public EmailNotificationTemplateModel()
        {
        }
