// <copyright file="QuestionModel.cs" company="Dasigno">
...
namespace Webcore.Areas.Admin.Models
{
    ...
    /// <summary>
    /// management the question information
    /// </summary>
    public class QuestionModel : IAdmin, IContent
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the question information
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the list of relation answers
        /// </summary>
        public IEnumerable<Answer> ListAnswers { get; set; }
