// <copyright file="SuccessStoryModel.cs" company="Dasigno">
...
namespace Webcore.Areas.Admin.Models
{
    ...
    /// </summary>
    public class SuccessStoryModel : IAdmin, IContent
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlogEntryModel"/> class
        /// </summary>
        public SuccessStoryModel()
        {
        }

        /// <summary>
        /// Gets or sets the Id of postulates
        /// </summary>
