// <copyright file="QuestionsPaging.cs" company="Dasigno">
...
namespace Domain.Entities.FrontEnd
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuestionsPaging"/> class
        /// </summary>
        public QuestionsPaging()
        {
        }
        ...
        public QuestionsPaging(IDataRecord obj)
        {
