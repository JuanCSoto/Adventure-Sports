// <copyright file="IdeasPaging.cs" company="Dasigno">
...
namespace Domain.Entities.FrontEnd
{
    ...
    /// </summary>
    public class IdeasPaging
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdeasPaging"/> class
        /// </summary>
        public IdeasPaging()
        {
        }
        ...
        public IdeasPaging(IDataRecord obj)
        {
