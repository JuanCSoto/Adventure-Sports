...
namespace Domain.Entities.FrontEnd
{
    ...
    public class BlogEntriesPaging
    {
        ...
        public BlogEntriesPaging(IDataRecord obj)
        {
        ...
        /// <summary>
        /// Gets or sets the short description second language
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the description second language
        /// </summary>
