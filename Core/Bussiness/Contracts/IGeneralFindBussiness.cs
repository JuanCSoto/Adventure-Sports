// <copyright file="IGeneralFindBussiness.cs" company="Intergrupo">
...
namespace Core.Bussiness.Contracts
{
    ...
    /// <summary>
    /// Expone las acciones para la lógica de negocio de la busqueda general.
    /// </summary>
    public interface IGeneralFindBussiness
    {
        /// <summary>
