...
namespace Business.FrontEnd
{
    ...
    public class FAQ : IFrontEnd
    {
        ...
        /// </summary>
        public List<FAQList> CollFAQ { get; set; }
        ...
        {
            FAQRepository faqrepository = new FAQRepository(session);
            this.CollFAQ = faqrepository.GetAllFrontEnd(LanguajeId);            
        }
    }
}
